...
local translations = {
    ...
    ["spoof midi info"] = {
        ["en"] = "This option is showing because you're in the game 'piano rooms'. When 'spoof midi' is ON, Auto Piano tells the game that all your inputs come from a real MIDI keyboard, not QWERTY! This makes autoplay more believable, since people will think you're playing a real piano. Just turn it on and play any song!",
        ["pt-BR"] = "Esta opção aparece porque você está no jogo 'piano rooms'. Quando 'falsificar midi' está LIGADO, Auto Piano diz ao jogo que seus inputs vêm de um teclado MIDI real, não de um QWERTY! Isso faz o autoplay parecer mais real. Basta ativar e tocar qualquer música!",
        ["es"] = "Esta opción aparece porque estás en el juego 'piano rooms'. Cuando 'falsificar midi' está ACTIVADO, Auto Piano le dice al juego que tus entradas vienen de un teclado MIDI real, no de QWERTY. Esto hace que el autoplay parezca más real. ¡Solo actívalo y toca cualquier canción!",
        ["ru"] = "Эта опция появилась, потому что вы в игре 'piano rooms'. Когда 'подделать midi' включён, Auto Piano сообщает игре, что все ваши нажатия идут с реальной MIDI-клавиатуры, а не QWERTY! Автовоспроизведение выглядит убедительнее — люди подумают, что вы играете на настоящем пианино. Просто включите и играйте любую песню!",
        ["zh-CN"] = "此选项出现是因为你在游戏“piano rooms”中。当“伪装 midi”开启时，Auto Piano 会告诉游戏你的输入来自真实的 MIDI 键盘，而不是 QWERTY！这样自动演奏更逼真，别人会以为你在弹钢琴。只需开启然后弹奏任意歌曲！",
        ["id"] = "Opsi ini muncul karena kamu sedang di game 'piano rooms'. Saat 'palsukan midi' AKTIF, Auto Piano memberi tahu game bahwa inputmu berasal dari keyboard MIDI asli, bukan QWERTY! Ini membuat autoplay lebih meyakinkan. Cukup aktifkan dan mainkan lagu apa pun!",
        ["fil"] = "Lalabas ang opsyong ito dahil nasa laro kang 'piano rooms'. Kapag naka-ON ang 'peke ang midi', sasabihin ng Auto Piano sa laro na galing sa totoong MIDI keyboard ang input mo, hindi QWERTY! Mas kapani-paniwala tuloy ang autoplay. I-on lang at tumugtog ng kahit anong kanta!",
        ["vi"] = "Tùy chọn này xuất hiện vì bạn đang ở trò chơi 'piano rooms'. Khi 'giả midi' BẬT, Auto Piano sẽ báo cho game rằng các thao tác của bạn đến từ bàn phím MIDI thật, không phải QWERTY! Điều này làm autoplay thuyết phục hơn. Chỉ cần bật lên và chơi bất kỳ bài nào!",
        ["fr"] = "Cette option apparaît car vous êtes dans le jeu 'piano rooms'. Quand 'simuler midi' est ACTIVÉ, Auto Piano fait croire au jeu que vos entrées viennent d’un vrai clavier MIDI, pas d’un QWERTY ! L’autoplay paraît ainsi plus crédible. Activez-le et jouez n’importe quelle chanson !",
        ["de"] = "Diese Option erscheint, weil du im Spiel 'piano rooms' bist. Wenn 'midi vortäuschen' AKTIV ist, sagt Auto Piano dem Spiel, dass deine Eingaben von einem echten MIDI-Keyboard kommen, nicht von QWERTY! Dadurch wirkt Autoplay glaubwürdiger. Einfach einschalten und ein Lied spielen!",
        ["ja"] = "このオプションはゲーム「piano rooms」にいるため表示されています。「midiを偽装」をオンにすると、Auto Piano はゲームにすべての入力がQWERTYではなく本物のMIDIキーボードから来ていると伝えます。これで自動演奏がより本物らしく見え、人々は本当にピアノを弾いていると思います。オンにして曲を弾くだけ！",
        ["ko"] = "이 옵션은 'piano rooms' 게임에 있기 때문에 표시됩니다. 'midi 스푸핑'을 켜면, Auto Piano가 게임에 당신의 입력이 QWERTY가 아닌 실제 MIDI 키보드에서 온 것처럼 알려줍니다! 이렇게 하면 자동 연주가 훨씬 그럴듯해집니다. 그냥 켜고 아무 노래나 연주해 보세요!",
        ["tr"] = "Bu seçenek 'piano rooms' oyununda olduğun için görünüyor. 'midi sahteleme' AÇIK olduğunda, Auto Piano oyuna tüm girişlerinin gerçek bir MIDI klavyeden geldiğini söyler, QWERTY’den değil! Bu, otomatik çalmayı daha inandırıcı yapar. Sadece aç ve herhangi bir şarkıyı çal!",
        ["ar"] = "يظهر هذا الخيار لأنك في لعبة 'piano rooms'. عند تفعيل 'تزييف midi'، سيخبر Auto Piano اللعبة أن جميع مدخلاتك تأتي من لوحة مفاتيح MIDI حقيقية، وليس QWERTY! هذا يجعل التشغيل التلقائي أكثر إقناعًا. فقط قم بتشغيله واعزف أي أغنية!"
    },
    ...
    ["custom song instructions"] = {
        ["en"] = "Convert a MIDI file into a song script using MIDI2LUA (bit.ly/midi2lua). Then, paste the full, unedited script here to add the song to your GUI in Auto Piano!",
        ["pt-BR"] = "Converta um arquivo MIDI em script usando MIDI2LUA (bit.ly/midi2lua). Depois, cole o script completo aqui para adicionar a música no Auto Piano!",
        ["es"] = "Convierte un archivo MIDI en script con MIDI2LUA (bit.ly/midi2lua). Luego pega el script completo aquí para añadir la canción en Auto Piano.",
        ["ru"] = "Преобразуйте MIDI-файл в скрипт через MIDI2LUA (bit.ly/midi2lua). Затем вставьте полный скрипт сюда, чтобы добавить песню в Auto Piano!",
        ["zh-CN"] = "使用 MIDI2LUA (bit.ly/midi2lua) 将 MIDI 文件转换为脚本。然后将完整脚本粘贴到这里，以添加歌曲到 Auto Piano！",
        ["id"] = "Ubah file MIDI jadi script dengan MIDI2LUA (bit.ly/midi2lua). Lalu tempel script lengkap di sini untuk menambah lagu ke Auto Piano!",
        ["fil"] = "I-convert ang MIDI file sa script gamit ang MIDI2LUA (bit.ly/midi2lua). Pagkatapos, i-paste ang buong script dito para maidagdag ang kanta sa Auto Piano!",
        ["vi"] = "Chuyển file MIDI thành script bằng MIDI2LUA (bit.ly/midi2lua). Sau đó dán script đầy đủ vào đây để thêm bài hát vào Auto Piano!",
        ["fr"] = "Convertissez un fichier MIDI en script avec MIDI2LUA (bit.ly/midi2lua). Puis collez le script complet ici pour ajouter la chanson à Auto Piano !",
        ["de"] = "Wandle eine MIDI-Datei in ein Script mit MIDI2LUA (bit.ly/midi2lua) um. Danach füge das vollständige Script hier ein, um das Lied in Auto Piano hinzuzufügen!",
        ["ja"] = "MIDIファイルをMIDI2LUA (bit.ly/midi2lua)でスクリプトに変換します。その後、完全なスクリプトをここに貼り付けてAuto Pianoに曲を追加してください！",
        ["ko"] = "MIDI 파일을 MIDI2LUA (bit.ly/midi2lua)로 변환하세요. 그런 다음 전체 스크립트를 여기에 붙여 넣어 Auto Piano에 노래를 추가하세요!",
        ["tr"] = "Bir MIDI dosyasını MIDI2LUA (bit.ly/midi2lua) ile script'e çevir. Sonra tam script'i buraya yapıştırarak şarkıyı Auto Piano'e ekle!",
        ["ar"] = "حوّل ملف MIDI إلى سكربت باستخدام MIDI2LUA (bit.ly/midi2lua). ثم الصق السكربت الكامل هنا لإضافة الأغنية في Auto Piano!"
    },
    ...
    ["songadded"] = {
        ...
        ["vi"] = "Bạn telah menambahkan lagu \"%s\".",
        ["fr"] = "Você adicionou a música \"%s\".",
    ...
    ["help info"] = {
        ["en"] = "Need help with Auto Piano? Want to turn MIDI files into autoplay scripts, find tutorials, or get help from the Discord server? Click the button below to copy the link to my official website!",
        ["pt-BR"] = "Precisa de ajuda com Auto Piano? Quer transformar arquivos MIDI em scripts de autoplay, encontrar tutoriais ou obter ajuda no Discord? Clique no botão abaixo para copiar o link do site oficial!",
        ["es"] = "¿Necesitas ayuda con Auto Piano? ¿Quieres convertir archivos MIDI en scripts de autoplay, encontrar tutoriais o recibir ayuda en Discord? Haz clic en el botón abajo para copiar el enlace a mi sitio oficial!",
        ["ru"] = "Нужна помощь с Auto Piano? Хотите конвертировать MIDI-файлы в скрипты автоплея, найти уроки или получить помощь в Discord? Нажмите кнопку ниже, чтобы скопировать ссылку на официальный сайт!",
        ["zh-CN"] = "需要 Auto Piano 的帮助吗？想将 MIDI 文件转换为自动播放脚本、查找教程 or 在 Discord 获取帮助？点击下方按钮复制我的官方网站链接！",
        ["id"] = "Perlu bantuan dengan Auto Piano? Ingin mengubah file MIDI menjadi script autoplay, mencari tutorial, atau mendapatkan bantuan dari Discord? Klik tombol di bawah untuk menyalin link situs resmi saya!",
        ["fil"] = "Kailangan mo ba ng tulong sa Auto Piano? Gusto mo bang gawing autoplay script ang MIDI files, humanap ng tutorials, o humingi ng tulong sa Discord? I-click ang button sa ibaba para kopyahin ang link sa aking opisyal na website!",
        ["vi"] = "Cần trợ giúp với Auto Piano? Muốn chuyển file MIDI thành script autoplay, tìm hướng dẫn hoặc nhận trợ giúp từ server Discord? Nhấn nút bên dưới để sao chép liên kết tới website chính thức của tôi!",
        ["fr"] = "Besoin d'aide avec Auto Piano ? Vous voulez convertir des fichiers MIDI en scripts d'autoplay, trouver des tutoriels ou obtenir de l'aide sur Discord ? Cliquez sur le bouton ci-dessous pour copier le lien vers mon site officiel !",
        ["de"] = "Brauchen Sie Hilfe mit Auto Piano? Möchten Sie MIDI-Dateien in Autoplay-Skripte umwandeln, Tutorials finden oder Hilfe im Discord erhalten? Klicken Sie auf die Schaltfläche unten, um den Link zu meiner offiziellen Website zu kopieren!",
        ["ja"] = "Auto Pianoの使い方で困っていますか？MIDIファイルを自動演奏スクリプトに変換したり、チュートリアルを探したり、Discordでサポートを受けたりできます。下のボタンをクリックして公式サイトのリンクをコピーしてください！",
        ["ko"] = "Auto Piano에 도움이 필요하신가요? MIDI 파일을 자동 재생 스크립트로 변환하거나, 튜토리얼을 찾거나, Discord 서버에서 도움을 받고 싶나요? 아래 버튼을 클릭하여 공식 웹사이트 링크를 복사하세요!",
        ["tr"] = "Auto Piano hakkında yardıma mı ihtiyacınız var? MIDI dosyalarını autoplay script’lere dönüştürmek, rehberler bulmak veya Discord sunucusundan yardım almak ister misiniz? Resmi web sitemin bağlantısını kopyalamak için aşağıdaki butona tıklayın!",
        ["ar"] = "تحتاج مساعدة مع Auto Piano؟ تريد تحويل ملفات MIDI إلى سكربتات تشغيل تلقائي، العثور على دروس، أو الحصول على المساعدة من سيرفر Discord؟ اضغط الزر أدناه لنسخ الرابط إلى موقعي الرسمي!"
    },
    ["categories"] = {
        ["en"] = "categories",
        ["pt-BR"] = "categorias",
    ...
    ["usenewloadstring"] = {
        ["en"] = "use Auto Piano from the new loadstring:",
        ["pt-BR"] = "use Auto Piano do novo loadstring:",
        ["es"] = "usa Auto Piano desde el nuevo loadstring:",
        ["ru"] = "используйте Auto Piano из новой loadstring:",
        ["zh-CN"] = "从新的 loadstring 使用 Auto Piano：",
        ["id"] = "gunakan Auto Piano dari loadstring baru:",
        ["fil"] = "gamitin ang Auto Piano mula sa bagong loadstring:",
        ["vi"] = "sử dụng Auto Piano từ loadstring mới:",
        ["fr"] = "utilisez Auto Piano depuis le nouveau loadstring :",
        ["de"] = "verwende Auto Piano aus dem neuen Loadstring:",
        ["ja"] = "新しい loadstring から Auto Piano を使用：",
        ["ko"] = "새 loadstring에서 Auto Piano 사용:",
        ["tr"] = "yeni loadstring'den Auto Piano kullan:",
        ["ar"] = "استخدم Auto Piano من loadstring الجديد:"
    },
...
function translator:requestLang(frame, type)
    ...
    if type == "first" then
        local success, result = pcall(readfile, "Auto Piano_language.txt")
        if success then
            savedLang = result
            ...
            warn("Failed to read file: Auto Piano_language.txt")
        end
    end
    ...
    Proceed.MouseButton1Click:Connect(function()
        pcall(function()
            writefile("Auto Piano_language.txt", selectedLanguage)
        end)
